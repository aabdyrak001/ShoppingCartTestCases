...
public class ShoppingCartTest {
    ...
    private boolean updateQuantity_withNullItemName_isRejected() {
        ...
        // THEN - ShoppingCart does not contain an item with null itemName, ShoppingCart still contains original item with original quantity
    ...
    private boolean updateQuantity_withEmptyItemName_isRejected() {
        ...
        // THEN -ShoppingCart does not contain an item with empty string itemName, ShoppingCart still contains original item with original quantity
        // `updateQuantity()` returns false
        if (result) {
